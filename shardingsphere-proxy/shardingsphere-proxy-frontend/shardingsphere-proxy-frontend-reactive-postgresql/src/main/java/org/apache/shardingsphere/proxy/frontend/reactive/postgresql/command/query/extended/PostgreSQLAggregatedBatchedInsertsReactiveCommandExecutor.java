...
public final class PostgreSQLAggregatedBatchedInsertsReactiveCommandExecutor implements ReactiveCommandExecutor {
    ...
    public Future<Collection<DatabasePacket<?>>> executeFuture() {
        ...
        PostgreSQLBatchedInsertsVertxExecutor executor = new PostgreSQLBatchedInsertsVertxExecutor(connectionSession, preparedStatement, readParameterSets(preparedStatement.getParameterTypes()));
        return executor.executeBatch().compose(totalInserted -> {
